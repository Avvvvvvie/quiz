...
```
1. Lock file bestimmen und wo der daemon laufen soll (tmp pfad)
2. Daemonizer starten
2.1 Fork von aktuellem Prozess erstellen
2.2 Ignoriere jeglichen input, ctrl-c, quit, hangup of terminal
2.3 Löse Sub Prozess von Parent
2.4 Wechsle in living directory
2.5 lock specific lockfile, nur 1 Prozess ist aktiv
2.6 reroute stdout & stderr zu file
2.7 Starte Daemon funktion
```
